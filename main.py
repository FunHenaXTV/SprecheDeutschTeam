    ...
    def click(self, event):
        ...
        if value < 2:
            ...
            if (event.x >= 0 and event.x < 960) and (event.y >= 220 and event.y < 650):
                print('square 1')
                character = canvas.create_polygon(500, 598, 600, 598, 600, 798, 500, 798, outline='green', fill='#fff', width=3)
                blocks.append(canvas.create_polygon(0, 800, 800, 800, 800, 1080, 0, 1080, outline='red', fill='#fff'))
                blocks.append(canvas.create_polygon(802, 900, 1000, 900, 1000, 1080, 802, 1080, outline='red', fill='#fff'))
                blocks.append(canvas.create_polygon(1002, 1000, 1200, 1000, 1200, 1080, 1002, 1080, outline='red', fill='#fff'))
                blocks.append(canvas.create_polygon(1202, 1030, 1920, 1030, 1920, 1080, 1202, 1080, outline='red', fill='#fff'))
                blocks.append(canvas.create_polygon(1602, 800, 1920, 800, 1920, 1030, 1602, 1030, outline='red', fill='#fff'))
                blocks.append(canvas.create_polygon(0, 450, 1200, 450, 1200, 505, 0, 505, outline='red', fill='#fff'))
                blocks.append(canvas.create_polygon(-2, 0, 0, 0, 0, 1080, -2, 1080, outline='red', fill='#fff'))
                blocks.append(canvas.create_polygon(1400, 900, 1600, 900, 1600, 1030, 1400, 1030, outline='red', fill='#fff'))
                blocks.append(canvas.create_polygon(1250, 950, 1398, 950, 1398, 1030, 1250, 1030, outline='red', fill='#fff'))
                blocks.append(canvas.create_polygon(1922, 900, 2200, 900, 2200, 1080, 1922, 1080, outline='red', fill='#fff'))
...
canvas.pack()
canvas.configure(xscrollincrement='0.5')
canvas.configure(yscrollincrement='0.5')
